...
void BME680::readReg(uint8_t addr, uint8_t count, uint8_t *pBuf) {
...
void BME680::writeReg(uint8_t addr, uint8_t dat) {
...
uint8_t BME680::TT(uint16_t TT) {  //TT is in 200 to 400
